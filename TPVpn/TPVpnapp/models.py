...
class Product(models.Model):
	...
	subcategory = models.CharField(max_length=120, blank=False, default='Ninguna')
	...
	barCode = models.CharField(max_length=120,blank=True,null=True,default='Vacio')
...
class Worker(models.Model):
	...
	dni = models.CharField(
		max_length=9, blank=False, unique=True, primary_key=True
	)
	...
	image = models.ImageField(
		blank=False, null=False, upload_to='users/profile',
...
class Client(models.Model):
	...
	image = models.ImageField(
		...
		default='clients/default/img.jpg', upload_to='clients/profile'
	)
	dni = models.CharField(
		max_length=9, blank=False, null=False, unique=True, primary_key=True
	)
...
class Sale(models.Model):
	sale_code = models.CharField(max_length=1000000,default=None,blank=True,null=True)
	...
	#subtotal = models.FloatField(max_length=100, default=0.0) #CAMPO INNECESARIO?
...
#PRODUCTO VENDIDO: SE GUARDARÁ INFO EN CASO DE MODIFICAR PRECIO U OTRO DATO
class ProductSale(models.Model):
	product = models.ForeignKey(Product, blank=True, null=True, default=None) # Relacion 1:1
...
class Notification(models.Model):
	reciver = models.ForeignKey(Worker, default=None, blank=True,null=True,related_name='reciver')
	reciverCli = models.ForeignKey(Client,default=None,blank=True,null=True)
	writer = models.ForeignKey(Worker, default=None, blank=True,null=True,related_name='writer')
